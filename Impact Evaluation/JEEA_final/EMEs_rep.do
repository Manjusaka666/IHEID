...
***********************************
	...
	*=============================================================================
* PARALLEL TRENDS TESTS FOR BAKER AND BRADY INITIATIVES
*=============================================================================
...
*-----------------------------------------------------------------------------
* BAKER INITIATIVE (1986) - PARALLEL TRENDS TEST
*-----------------------------------------------------------------------------

* Generate lead and lag indicators for 1986 event
forval i = 5(-1)1 {
    capture drop lead`i'_1986
    gen lead`i'_1986 = (y1986_index == -`i') & Baker_treat==1
}

forval i = 1/5 {
    capture drop lag`i'_1986
    gen lag`i'_1986 = (y1986_index == `i') & Baker_treat==1
}

* Parallel trends test for GDP growth (Baker 1986)
quietly xtreg EME_real_pc_growth lead5_1986 lead4_1986 lead3_1986 lead2_1986 ///
    lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986 _Iyear_* ///
    if DiD1986_5year==1, fe cluster(codeid)
estimates store pt_growth1986

* Test joint significance of leads (pre-treatment periods)
test lead5_1986 lead4_1986 lead3_1986 lead2_1986
local p_val_growth1986 = r(p)
display "1986 Baker GDP Growth - Parallel Trends Test p-value: " `p_val_growth1986'

* Parallel trends test for Credit Ratings (Baker 1986)
quietly xtreg ratings_growth lead5_1986 lead4_1986 lead3_1986 lead2_1986 ///
    lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986 _Iyear_* ///
    if DiD1986_5year==1, fe cluster(codeid)
estimates store pt_ratings1986

test lead5_1986 lead4_1986 lead3_1986 lead2_1986
local p_val_ratings1986 = r(p)
display "1986 Baker Credit Ratings - Parallel Trends Test p-value: " `p_val_ratings1986'

* Parallel trends test for Debt Service to Exports (Baker 1986)
quietly xtreg DebtService_Exports lead5_1986 lead4_1986 lead3_1986 lead2_1986 ///
    lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986 _Iyear_* ///
    if DiD1986_5year==1, fe cluster(codeid)
estimates store pt_debtserv1986

test lead5_1986 lead4_1986 lead3_1986 lead2_1986
local p_val_debtserv1986 = r(p)
display "1986 Baker Debt Service - Parallel Trends Test p-value: " `p_val_debtserv1986'

* Parallel trends test for Debt/GDP (Baker 1986)
quietly xtreg debt_gdpAbbas lead5_1986 lead4_1986 lead3_1986 lead2_1986 ///
    lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986 _Iyear_* ///
    if DiD1986_5year==1, fe cluster(codeid)
estimates store pt_debt1986

test lead5_1986 lead4_1986 lead3_1986 lead2_1986
local p_val_debt1986 = r(p)
display "1986 Baker Debt/GDP - Parallel Trends Test p-value: " `p_val_debt1986'

* Parallel trends test for External Debt/GNI (Baker 1986)
quietly xtreg DebtExt_GNI lead5_1986 lead4_1986 lead3_1986 lead2_1986 ///
    lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986 _Iyear_* ///
    if DiD1986_5year==1, fe cluster(codeid)
estimates store pt_extdebt1986

test lead5_1986 lead4_1986 lead3_1986 lead2_1986
local p_val_extdebt1986 = r(p)
display "1986 Baker External Debt - Parallel Trends Test p-value: " `p_val_extdebt1986'

*-----------------------------------------------------------------------------
* BRADY INITIATIVE (1990) - PARALLEL TRENDS TEST
*-----------------------------------------------------------------------------

* Generate lead and lag indicators for 1990 event
forval i = 5(-1)1 {
    capture drop lead`i'_1990
    gen lead`i'_1990 = (y1990_index == -`i') & Brady_treat==1
}

forval i = 1/5 {
    capture drop lag`i'_1990
    gen lag`i'_1990 = (y1990_index == `i') & Brady_treat==1
}

* Parallel trends test for GDP growth (Brady 1990)
quietly xtreg EME_real_pc_growth lead5_1990 lead4_1990 lead3_1990 lead2_1990 ///
    lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990 _Iyear_* ///
    if DiD1990_5year==1, fe cluster(codeid)
estimates store pt_growth1990

test lead5_1990 lead4_1990 lead3_1990 lead2_1990
local p_val_growth1990 = r(p)
display "1990 Brady GDP Growth - Parallel Trends Test p-value: " `p_val_growth1990'

* Parallel trends test for Credit Ratings (Brady 1990)
quietly xtreg ratings_growth lead5_1990 lead4_1990 lead3_1990 lead2_1990 ///
    lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990 _Iyear_* ///
    if DiD1990_5year==1, fe cluster(codeid)
estimates store pt_ratings1990

test lead5_1990 lead4_1990 lead3_1990 lead2_1990
local p_val_ratings1990 = r(p)
display "1990 Brady Credit Ratings - Parallel Trends Test p-value: " `p_val_ratings1990'

* Parallel trends test for Debt Service to Exports (Brady 1990)
quietly xtreg DebtService_Exports lead5_1990 lead4_1990 lead3_1990 lead2_1990 ///
    lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990 _Iyear_* ///
    if DiD1990_5year==1, fe cluster(codeid)
estimates store pt_debtserv1990

test lead5_1990 lead4_1990 lead3_1990 lead2_1990
local p_val_debtserv1990 = r(p)
display "1990 Brady Debt Service - Parallel Trends Test p-value: " `p_val_debtserv1990'

* Parallel trends test for Debt/GDP (Brady 1990)
quietly xtreg debt_gdpAbbas lead5_1990 lead4_1990 lead3_1990 lead2_1990 ///
    lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990 _Iyear_* ///
    if DiD1990_5year==1, fe cluster(codeid)
estimates store pt_debt1990

test lead5_1990 lead4_1990 lead3_1990 lead2_1990
local p_val_debt1990 = r(p)
display "1990 Brady Debt/GDP - Parallel Trends Test p-value: " `p_val_debt1990'

* Parallel trends test for External Debt/GNI (Brady 1990)
quietly xtreg DebtExt_GNI lead5_1990 lead4_1990 lead3_1990 lead2_1990 ///
    lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990 _Iyear_* ///
    if DiD1990_5year==1, fe cluster(codeid)
estimates store pt_extdebt1990

test lead5_1990 lead4_1990 lead3_1990 lead2_1990
local p_val_extdebt1990 = r(p)
display "1990 Brady External Debt - Parallel Trends Test p-value: " `p_val_extdebt1990'
...
matrix pt_results = J(10, 3, .)
matrix rownames pt_results = "Baker_GDP_Growth" "Baker_Ratings" "Baker_DebtServ" ///
    "Baker_Debt_GDP" "Baker_ExtDebt" ///
    "Brady_GDP_Growth" "Brady_Ratings" "Brady_DebtServ" ///
    "Brady_Debt_GDP" "Brady_ExtDebt"
matrix colnames pt_results = "P_Value" "Pass_5pct" "Pass_10pct"

* Fill in results for Baker Initiative
matrix pt_results[1,1] = `p_val_growth1986'
matrix pt_results[1,2] = (`p_val_growth1986' > 0.05)
matrix pt_results[1,3] = (`p_val_growth1986' > 0.10)

matrix pt_results[2,1] = `p_val_ratings1986'
matrix pt_results[2,2] = (`p_val_ratings1986' > 0.05)
matrix pt_results[2,3] = (`p_val_ratings1986' > 0.10)

matrix pt_results[3,1] = `p_val_debtserv1986'
matrix pt_results[3,2] = (`p_val_debtserv1986' > 0.05)
matrix pt_results[3,3] = (`p_val_debtserv1986' > 0.10)

matrix pt_results[4,1] = `p_val_debt1986'
matrix pt_results[4,2] = (`p_val_debt1986' > 0.05)
matrix pt_results[4,3] = (`p_val_debt1986' > 0.10)

matrix pt_results[5,1] = `p_val_extdebt1986'
matrix pt_results[5,2] = (`p_val_extdebt1986' > 0.05)
matrix pt_results[5,3] = (`p_val_extdebt1986' > 0.10)

* Fill in results for Brady Initiative
matrix pt_results[6,1] = `p_val_growth1990'
matrix pt_results[6,2] = (`p_val_growth1990' > 0.05)
matrix pt_results[6,3] = (`p_val_growth1990' > 0.10)

matrix pt_results[7,1] = `p_val_ratings1990'
matrix pt_results[7,2] = (`p_val_ratings1990' > 0.05)
matrix pt_results[7,3] = (`p_val_ratings1990' > 0.10)

matrix pt_results[8,1] = `p_val_debtserv1990'
matrix pt_results[8,2] = (`p_val_debtserv1990' > 0.05)
matrix pt_results[8,3] = (`p_val_debtserv1990' > 0.10)

matrix pt_results[9,1] = `p_val_debt1990'
matrix pt_results[9,2] = (`p_val_debt1990' > 0.05)
matrix pt_results[9,3] = (`p_val_debt1990' > 0.10)

matrix pt_results[10,1] = `p_val_extdebt1990'
matrix pt_results[10,2] = (`p_val_extdebt1990' > 0.05)
matrix pt_results[10,3] = (`p_val_extdebt1990' > 0.10)
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
* BAKER INITIATIVE (1986) - ALL PARALLEL TRENDS PLOTS
*-----------------------------------------------------------------------------

* Plot 1: Baker Initiative - GDP Growth
coefplot pt_growth1986, ///
    keep(lead5_1986 lead4_1986 lead3_1986 lead2_1986 lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: GDP Growth (Baker Initiative 1986)") ///
    note("Pre-treatment test p-value: `p_val_growth1986'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Baker_GDP.png", replace width(800) height(600)

* Plot 2: Baker Initiative - Credit Ratings
coefplot pt_ratings1986, ///
    keep(lead5_1986 lead4_1986 lead3_1986 lead2_1986 lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Credit Ratings (Baker Initiative 1986)") ///
    note("Pre-treatment test p-value: `p_val_ratings1986'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Baker_Ratings.png", replace width(800) height(600)

* Plot 3: Baker Initiative - Debt Service to Exports
coefplot pt_debtserv1986, ///
    keep(lead5_1986 lead4_1986 lead3_1986 lead2_1986 lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Debt Service to Exports (Baker Initiative 1986)") ///
    note("Pre-treatment test p-value: `p_val_debtserv1986'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Baker_DebtServ.png", replace width(800) height(600)

* Plot 4: Baker Initiative - Debt/GDP
coefplot pt_debt1986, ///
    keep(lead5_1986 lead4_1986 lead3_1986 lead2_1986 lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Debt/GDP (Baker Initiative 1986)") ///
    note("Pre-treatment test p-value: `p_val_debt1986'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Baker_Debt.png", replace width(800) height(600)

* Plot 5: Baker Initiative - External Debt/GNI
coefplot pt_extdebt1986, ///
    keep(lead5_1986 lead4_1986 lead3_1986 lead2_1986 lag1_1986 lag2_1986 lag3_1986 lag4_1986 lag5_1986) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: External Debt/GNI (Baker Initiative 1986)") ///
    note("Pre-treatment test p-value: `p_val_extdebt1986'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Baker_ExtDebt.png", replace width(800) height(600)

*-----------------------------------------------------------------------------
* BRADY INITIATIVE (1990) - ALL PARALLEL TRENDS PLOTS
*-----------------------------------------------------------------------------

* Plot 6: Brady Initiative - GDP Growth
coefplot pt_growth1990, ///
    keep(lead5_1990 lead4_1990 lead3_1990 lead2_1990 lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: GDP Growth (Brady Initiative 1990)") ///
    note("Pre-treatment test p-value: `p_val_growth1990'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Brady_GDP.png", replace width(800) height(600)

* Plot 7: Brady Initiative - Credit Ratings
coefplot pt_ratings1990, ///
    keep(lead5_1990 lead4_1990 lead3_1990 lead2_1990 lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Credit Ratings (Brady Initiative 1990)") ///
    note("Pre-treatment test p-value: `p_val_ratings1990'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Brady_Ratings.png", replace width(800) height(600)

* Plot 8: Brady Initiative - Debt Service to Exports
coefplot pt_debtserv1990, ///
    keep(lead5_1990 lead4_1990 lead3_1990 lead2_1990 lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Debt Service to Exports (Brady Initiative 1990)") ///
    note("Pre-treatment test p-value: `p_val_debtserv1990'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Brady_DebtServ.png", replace width(800) height(600)

* Plot 9: Brady Initiative - Debt/GDP
coefplot pt_debt1990, ///
    keep(lead5_1990 lead4_1990 lead3_1990 lead2_1990 lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: Debt/GDP (Brady Initiative 1990)") ///
    note("Pre-treatment test p-value: `p_val_debt1990'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Brady_Debt.png", replace width(800) height(600)

* Plot 10: Brady Initiative - External Debt/GNI
coefplot pt_extdebt1990, ///
    keep(lead5_1990 lead4_1990 lead3_1990 lead2_1990 lag1_1990 lag2_1990 lag3_1990 lag4_1990 lag5_1990) ///
    vertical ///
    yline(0, lcolor(red) lpattern(dash)) ///
    xlabel(1 "t-5" 2 "t-4" 3 "t-3" 4 "t-2" 5 "t+1" 6 "t+2" 7 "t+3" 8 "t+4" 9 "t+5") ///
    ytitle("") ///
    title("Parallel Trends Test: External Debt/GNI (Brady Initiative 1990)") ///
    note("Pre-treatment test p-value: `p_val_extdebt1990'") ///
    graphregion(color(white)) plotregion(color(white))
graph export "PT_Brady_ExtDebt.png", replace width(800) height(600)
