...
\ifsubmission
    ...
    The results support a disciplined message: sentiment has limited incremental value for point-forecast accuracy conditional on prices (Table~\ref{tab:rmsfe}), but it can shift systematic patterns in forecast updating as measured by the revision diagnostic (Table~\ref{tab:cg_regression}).
    ...
    Future work priorities include real-time data vintages, alternative sentiment measures, and distributional forecast evaluation.
\else
