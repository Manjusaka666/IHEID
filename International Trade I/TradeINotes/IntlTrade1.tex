...
\professor[https://www.monikamrazova.com/]{Monika Mrázová(UNIGE)}
...
\chapter{The Specific Factors Model (Ricardo-Viner)}
\input{lectures/lec4}
\chapter{The Heckscher-Ohlin Model}
\input{lectures/Lec5}
\chapter{Monopolistic Competition and Trade}
\input{lectures/Lec6}
