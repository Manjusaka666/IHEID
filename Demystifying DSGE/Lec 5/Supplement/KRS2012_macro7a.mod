...
%written by Qianchao Qu
%This file is for replicating the impulse responses under the augmented Taylor rule (gammab=0.3) plus macroprudential policy regime (tau=0.3); 
var 
      q   c   i   mu   d   r   deltac   deltap   deltapC   b   p   pC   pD   deltapD   lC   lD   wC   wD   cB   deltacB   iB   muB   dB   lCB   lDB   rL   bB   aC   xiD   v   lCtot   lDtot   y   ystar   yC   yD   yCstar   yDstar   dstar   deltabB
   ygap   % new variables added by JC
;
...
gammay = 0.125;
%gammab = 0.3;
%gammab = 0.05; % test lower value of gammab
gammab = 0.15; % test lower value of gammab
tau = 0.3;
rhoC = 0.98;
rhoD = 0.95;
rhov = 0.95;
...
stoch_simul(Tex,order=1, irf=24) yC yD y deltapC deltapD ygap r rL deltabB ;
/*
%----------------------------------------------------------------
