...
delta_h = 0; % no indexation for Q5b
delta_f = 0; % no indexation for Q5b
...
% ESTIMATION
%*************************************************************************
estimation(Tex, datafile = Data4Exam, first_obs = 1, kalman_algo = 4, prefilter = 1, mode_compute = 5, mh_replic = 0) y pi r q s e pi_h pi_f;
