...
r = psi_r * r(-1) + (1 - psi_r) * (psi_pi * pi + psi_y * y + psi_de * (e - e(-1))) + eps_r; %Taylor rule equation 26
...
stoch_simul(Tex, irf = 24) y pi r q s e pi_h pi_f;
%----------------------------------------------------------------
% 5. Estimation
%----------------------------------------------------------------
%*************************************************************************
...
% ...
% psi_y, normal_pdf, 0.2, 0.1;
% psi_pi, normal_pdf, 0.2, 0.1;
% psi_r, normal_pdf, 0.2, 0.1;
...
% ESTIMATION
%*************************************************************************
estimation(Tex, datafile = Data4Exam, kalman_algo = 4, prefilter = 1, mode_compute = 5, mh_replic = 0) y pi r q s e pi_h pi_f;
