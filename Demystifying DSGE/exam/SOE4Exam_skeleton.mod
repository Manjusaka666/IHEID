...
rho_q ${\ rho_{s}}$ (long_name = 'ER persistence')
...
% OBSERVED VARIABLES
%*************************************************************************
varobs y_obs yst_obs r_obs pi_obs;

%*************************************************************************
% ESTIMATION
%*************************************************************************
estimation(Tex, datafile = Data4Exam, kalman_algo = 4, prefilter = ?, mode_compute = 5, mh_replic = 0) y pi r q s e pi_h pi_f;
