...
This Readme-File explains how to run the Matlab Code in the zip-file "Code_CCTW_2010" 
to replicate figure 2 and 3 of the paper J.F. Cogan, T. Cwik, J.B. Taylor and 
...
2) Unzip the zip-file "Code_CCTW_2010" in a folder you choose.
3) Start Matlab and change the current directory to the folder "Code_CCTW_2010". 
