...
var  
	...
	sobs 	    ${Spread}$      (long_name='BBB-AAA Rate Spread') % Cai et al use (BAA-10yrTreasury)
...
estimation(Tex,optim=('MaxIter',20000),datafile='SW_Data4HW2025.xlsx',
            xls_sheet=Newsobs,mode_compute=1,
            first_obs=1,nobs=241,presample=4,lik_init=2,
            prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.2, irf=24) ;
