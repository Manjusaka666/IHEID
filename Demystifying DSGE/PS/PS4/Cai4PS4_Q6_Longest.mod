...
%SW data period 1965Q1-2004Q4 uses nobs=160
estimation(smoother, mode_compute=0, mode_file='E:\IHEID Economics\IHEID\Demystifying DSGE\PS\PS4\Cai_4PS4\Output\Cai_4PS4_mode.mat',
            Tex,
            datafile='SW_Data4HW2025.xlsx', 
            xls_sheet=NewSobs, 
            first_obs=1, nobs=241, 
            presample=4, lik_init=2, prefilter=0, mh_replic=20000, 
            mh_nblocks=2,mh_jscale=0.2, irf=24);
            
shock_decomposition(init_state=0, first_obs=161, nobs=80) inve;
