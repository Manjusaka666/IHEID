...
% This is a COPY of the original SW2007 model, to be used for HW etc.
% This version (4HW3Q3) is for HW3Q3
% This version (4HW3Q5) is identical to version 4HW3Q3 EXCEPT that it uses the estimated rather than calibrated parameters
% This version (4HW3Q6) is identical to version 4HW3Q5 EXCEPT that it uses the Dixit-Stiglitz aggregator by setting the parameters “curvp” and “curvw” both equal to zero
...
cg=0.18;
%curvp=10; % Kimball
curvp=0; % to test Dixit-Stiglitz vs Kimball
curvw=10; % Kimball
curvw=0;  % to test Dixit-Stiglitz vs Kimball
// estimated parameters initialisation
% Below are modes from posterior distribution in Table 1A
calfa=.19;
cbeta=.9984;
cgamma=1.0043;
csigma=1.39;
...
cry=      0.08;
crdy=     0.22;
% Below are modes from posterior distribution in Table 1B
cgy=0.52; % rho_ga
crhoa=    0.95;
crhob=    0.18;
crhog=    0.97;
