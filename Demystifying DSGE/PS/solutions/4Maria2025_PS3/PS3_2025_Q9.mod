% E:\MyCourseDSGEs\SW\SW2007\Shocks and Frictions in US Business Cycles - Bayesian Approach
% For Q9 - uses Herbst-Schorf Priors and RWMH
var 
...
% Herbst-Schorf
% Structural
calfa,0.24,0.01,1.0,NORMAL_PDF,0.3,0.15;
czcap,0.2648,0.01,1,UNIFORM_PDF,0,1;
cfc,1.4672,1.0,3,NORMAL_PDF,1.25,0.36;
cindw,0.4425,0.01,0.99,UNIFORM_PDF,0,1;
cprobw,0.7937,0.3,0.95,UNIFORM_PDF,0,1;
cindp,0.3291,0.01,0.99,UNIFORM_PDF,0,1;
cprobp,0.7813,0.5,0.95,UNIFORM_PDF,0,1;
csigma,1.2312,0.25,3,NORMAL_PDF,1.50,1.11;
csigl,2.8401,0.25,10,NORMAL_PDF,2,2.25;
chabb,0.7205,0.001,0.99,UNIFORM_PDF,0,1;
csadjcost,6.3325,2,15,NORMAL_PDF,4,4.5;
cmaw,.8936,0.01,.9999,UNIFORM_PDF,0,1;
cmap,.7652,0.01,.9999,UNIFORM_PDF,0,1;
ctrend,0.3982,0.1,0.8,NORMAL_PDF,0.4,0.30;
constebeta,0.7420,0.01,2.0,GAMMA_PDF,0.25,0.1;% HS use 0.30 but this makes the prior distribution unbounded
constepinf,0.7,0.1,2.0,GAMMA_PDF,0.625,0.3;%20;
constelab,1.2918,-10.0,10.0,NORMAL_PDF,0.0,6.0;
%MonPol
crpi,1.7985,1.0,3,NORMAL_PDF,1.5,0.75;
crdy,0.2239,0.001,0.5,NORMAL_PDF,0.125,0.15;
cry,0.0893,0.001,0.5,NORMAL_PDF,0.125,0.15;
crr,0.8258,0.5,0.975,UNIFORM_PDF,0,1;
%Persistence
crhoa,.9676 ,.01,.9999,UNIFORM_PDF,0,1;
cgy,0.05,0.01,2.0,UNIFORM_PDF,0,1;
crhob,.2703,.01,.9999,UNIFORM_PDF,0,1;
crhog,.9930,.01,.9999,UNIFORM_PDF,0,1;
crhoqs,.5724,.01,.9999,UNIFORM_PDF,0,1;
crhoms,.3,.01,.9999,UNIFORM_PDF,0,1;
crhopinf,.8692,.01,.9999,UNIFORM_PDF,0,1;
crhow,.9546,.001,.9999,UNIFORM_PDF,0,1;
% Variance
...
estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xlsx',xls_sheet=GSW,mode_compute=6,first_obs=71,nobs=160, presample=4,lik_init=2,prefilter=0,mh_replic=20000,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);
