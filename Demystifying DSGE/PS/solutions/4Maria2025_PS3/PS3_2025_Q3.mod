...
% Up to 2004Q1
estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xlsx',xls_sheet=D1965Q1,mode_compute=1,first_obs=1,nobs=160,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);

% For 1980Q1 to 2015Q4
%estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xls',xls_sheet=obs,mode_compute=1,first_obs=61,nobs=144,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);

% For 1967Q1 to 1991Q4
%estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xls',xls_sheet=obs,mode_compute=1,first_obs=9,nobs=100,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);

% Great Inflation from 1966Q2 to 1979Q2 (inclusive)
%estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xls',xls_sheet=obs,mode_compute=1,first_obs=6,nobs=53,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);

% Great Moderation from 1984Q1 to 2004Q4 (inclusive)
%estimation(optim=('MaxIter',200),datafile='SW_Data4HW2025.xls',xls_sheet=obs,mode_compute=1,first_obs=77,nobs=84,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);

% RWMH
%estimation(optim=('MaxIter',200),datafile='SW_Data4HW.xls',xls_sheet=obs,mode_compute=6,first_obs=1,nobs=160,presample=4,lik_init=2,prefilter=0,mh_replic=20000,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);
