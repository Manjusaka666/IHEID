...
% estimation(optim=('MaxIter',200),datafile='XXX',xls_sheet=YYY,mode_compute=1,first_obs=ZZZ,nobs=WWW, presample=4,lik_init=2,prefilter=0,mh_replic=UUU,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex);
estimation(optim=('MaxIter',200),
           datafile='SW_Data4HW', xls_sheet=Obs,
           mode_compute=1,
           first_obs=1, nobs=160,   % 1965Q1–2004Q4 inclusive = 40*4 = 160
