...
estimation(optim=('MaxIter',200),datafile='SW_Data4HW_Wei.xlsx',xls_sheet='Obs',mode_compute=1,first_obs=41,nobs=160, presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2,Tex) y c inve pinf r w k lab;
