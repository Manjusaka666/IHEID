...
clandaw=1.5;
cg=0.18;
% Dixit-Stigler curvature parameters set to zero for Calvo
curvp=0;
curvw=0;
% --- FIX CALVO PROBABILITIES at 0.5 ---
cprobp = 0.5;  % <-- price Calvo fixed
cprobw = 0.5;  % <-- wage Calvo fixed    
