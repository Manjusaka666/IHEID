...
Our simulated result replrts a mean of -17.69, with a standard error of 2.6087, which is close to our theoretical expectation, 
...
Our simulated result reports a mean of 4.9383, with a standard error of 1.2396, which is closer to the true value and less volatile than regression (1).
...
The simulated result reports a mean of 4.9941, with a standard error of 0.1844, which is almost the true value.
...
The simulated result reports a mean of 4.9529, with a standard error of 1.2403, which satisfies our expectation.
...
The simulated result reports a mean of 4.9499, with a standard error of 1.2584, which estimated $\beta$ worse than regression (4), as well as a higher standard error than reegression (2) and (4).
