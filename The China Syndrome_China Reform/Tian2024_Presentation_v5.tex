...
\author[Tian (2024)]{Yuan Tian\\\small Presented by Christopher}
...
% -----------------------------------------------------------------------------
\begin{frame}{How I would present the paper's bottom line}
\begin{itemize}
...
% -----------------------------------------------------------------------------
\begin{frame}{References used for contextual critique}
\footnotesize
\begin{itemize}
    \item Tian, Yuan. 2024. ``International Trade Liberalization and Domestic Institutional Reform.'' \emph{Review of Economics and Statistics} 106(3): 794--813.
    \item Cheng, Tiejun, and Mark Selden. 1994. ``The Origins and Social Consequences of China's Hukou System.'' \emph{The China Quarterly} 139: 644--668.
    \item Chan, Kam Wing, and Li Zhang. 1999. ``The Hukou System and Rural-Urban Migration in China: Processes and Changes.'' \emph{The China Quarterly} 160: 818--855.
    \item Solinger, Dorothy J. 1999. \emph{Contesting Citizenship in Urban China}. University of California Press.
    \item Wang, Fei-Ling. 2005. \emph{Organizing Through Division and Exclusion: China's Hukou System}. Stanford University Press.
    \item Chan, Kam Wing. 2019. ``China's Hukou System at 60: Continuity and Reform.'' In \emph{Handbook on Urban Development in China}. Edward Elgar.
\end{itemize}
\end{frame}
...
\begin{enumerate}
    \item If Hukou is a political institution of state control, how far can an export-demand shock explain reform?
    \item Does the evidence identify institutional change, or only textual policy adjustment?
    \item Should we interpret pro-migrant regulations as inclusion, labor-market management, or both?
    \item How would a structural model separate direct trade effects from regulation-mediated migration effects?
\end{enumerate}
\end{frame}
